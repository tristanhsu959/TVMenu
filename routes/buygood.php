...
Route::middleware([AuthMiddleware::class])->group(function(){
	...
	/* 供應商出貨總量查詢 */
	Route::middleware([AccessPermissionMiddleware::class . Str::start(Functions::BG_PURCHASE_SUPPLIER->value, ':')])->group(function(){
	...
	/* 產品查詢 */
	Route::middleware([AccessPermissionMiddleware::class . Str::start(Functions::BG_PURCHASE_PRODUCT_INFO->value, ':')])->group(function(){
